...
# Created: Tue Dec  4 11:49:59 PST 2012
#
#/ usage: python-setuptools:build  --version <>  --directory <> [ --url <http://pypi.python.org/packages/source>]  --name <> [ --package-format <rpm>] [ --package-release <1>] [ --package-name <>] 
